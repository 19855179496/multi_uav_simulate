     ...
     controller_(controller)
{
  ...
  //100hz定时器计算控制量
  //time1 = nh_.createTimer(ros::Duration(0.01), &StateMachineDefinition::TimerCallback, this);
}

void StateMachineDefinition::TimerCallback(const ros::TimerEvent& e)
{
   // std::cout << "StateMachineDefinition::TimerCallback" << std::endl;
