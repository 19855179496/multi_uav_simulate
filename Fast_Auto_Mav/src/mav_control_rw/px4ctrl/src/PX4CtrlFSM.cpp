...
void PX4CtrlFSM::process()
{
    ...
    else
    {
        ...
        //debug_msg = controller.MpcControl(des, odom_data, imu_data, u);
        // debug_msg.header.stamp = now_time;
        // debug_pub.publish(debug_msg);

        // Eigen::Vector3d imu_angle = controller.fromQuaternion2euler(imu_data.q);
        // static int count0 = 0;
        // if(count0 > 100)
        // {
        //     //
        ...
        //     // ROS_INFO_STREAM("imu_angle "<<imu_angle.transpose());
        //     // ROS_INFO_STREAM("desp "<<des.p.transpose());
        //     // ROS_INFO_STREAM("desyaw "<<des.yaw);
        //     count0 = 0;
        // }
        // count0 ++;
    ...
    else
    {
        ...
        mav_msgs::msgMultiDofJointTrajectoryFromPositionVelAccYaw(
                des.p, des.v,des.a,des.yaw, &trajectory_msg);
